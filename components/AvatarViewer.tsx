...
const CUSTOM_ANIMATIONS: Record<string, any> = {
    ...
    'HOW OLD ARE YOU': require('../assets/ilang_taon_ka_na.glb'),
    'ILANG TAON KA NA': require('../assets/ilang_taon_ka_na.glb'),
    'WHERE DO YOU LIVE': require('../assets/saan_ka_nakatira.glb'),
    'SAAN KA NAKATIRA': require('../assets/saan_ka_nakatira.glb'),
